  ...
  return (
    <div className = {`sidebar ${isSidebarOpen ? 'sidebar-open' : ""}`}>
        ...
        <Link className='navbar-brand text-white flex align-center fs-26' to = "/">
            ...
            <span className='navbar-brand-txt font-rubik fw-5'>SIST ESTATE</span>
        </Link>
        <ul className = "sidebar-nav font-rubik my-5">
            ...
            <li className='nav-item'>
                <Link to = "/blog" className='nav-link text-white fw-4 fs-18'>About</Link>
            </li>
            <li className='nav-item'>
                <Link to = "/about" className='nav-link text-white fw-4 fs-18'>Subscribe</Link>
            </li>
        </ul>
        <div className='sidebar-blocks my-5'>
            ...
            <div className='sidebar-block'>
                ...
                <p className='text-white'>property@contact.com</p>
            </div>
        </div>
    </div>
  )
